...
DSP blocks
Systolic Array Hardware Accelerator Concept
Definition

A Systolic Array Hardware Accelerator is a parallel hardware architecture consisting of multiple interconnected processing elements that perform repetitive computations in a synchronized pipeline manner.

The term "systolic" comes from rhythmic movement like heartbeat.

Data flows rhythmically between processing elements.

Need

Software computation is slower for:
...
Hardware acceleration solves this.
...
Two data streams move through array.
...
Image filtering
DSP
32-bit ALU with RAM, Control Unit, Program Counter Concept
Definition

A mini processor subsystem integrating computation, memory, and instruction sequencing.
